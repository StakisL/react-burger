				...
				<section className="nav-section">
					<span className="nav-link-container mt-4 mb-4">
						<a className="nav-link" href="1">
							...
							<p className="nav-link__text text_type_main-default">Конструктор</p>
						</a>
						<a className="nav-link" href="2">
							<ListIcon className="nav-link__logo" type="secondary" />
							<p className="nav-link__text text_type_main-default">Лента заказов</p>
						</a>
					</span>
					...
					<span className="nav-link-container mt-4 mb-4">
						<a className="nav-link" href="3">
							...
							<p className="nav-link__text text_type_main-default">Личный кабинет</p>
						</a>
					</span>
				</section>
			</nav>
