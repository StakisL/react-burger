...
function IngredientDetails(props) {
	return (
		<section className={detailStyles.ingredient_detail}>
			...
			<p className={`${detailStyles.ingredient_name} text_type_main-default mt-4 mb-4`}>
				{props.ingredient.name}
			</p>
			<ul className={`${detailStyles.ingredient_info_list} mt-4 mb-15`}>
				<li className={`${detailStyles.ingredient_info_list__item} mr-5`}>
					<p
						className={` ${detailStyles.ingredient_info_list__item_text} text_type_main-small text_color_inactive`}
					>
						Калории, ккал
					</p>
					<p
